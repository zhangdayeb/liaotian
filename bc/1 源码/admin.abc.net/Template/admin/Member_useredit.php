...
{/volist}
        ...
        {if condition="$info.proxy eq 1"}
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>上级:</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{$parent.username}" placeholder="上级用户名" name="parent">
                </div>
            </div>
        {/if}
        <div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>可看视屏：</label>
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="radio-box">
					<input name="showav" type="radio" id="showav-1" value="1" {if condition="$info['showav'] eq 1"}checked{/if}>
					<label for="showav-1">是</label>
				</div>
				<div class="radio-box">
					<input type="radio" id="showav-0" name="showav" value="0" {if condition="$info['showav'] eq 0"}checked{/if}>
					<label for="showav-0">否</label>
				</div>
			</div>
		</div>
