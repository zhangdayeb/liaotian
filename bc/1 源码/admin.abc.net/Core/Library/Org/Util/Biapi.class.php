...
class Biapi extends JoDES{
	...
	*/
	...
	private  $WebSiteCode=''; //站点code
	
	private  $password=''; 								//站点用户密码
	
	private  $biUrl = '';
	// 额度转换
	
	function __construct(){
		$this->key=GetVar('biapi_key');
		$this->WebSiteCode=GetVar('biapi_sitecode');
		$this->password=GetVar('biapi_userpass');
		$this->biUrl=GetVar('biapi_apiurl');
	}
