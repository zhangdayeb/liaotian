<?php if (!defined('THINK_PATH')) exit();?><html lang="en" class="js cssanimations"><head>
    <meta charset="UTF-8">
    <title>午夜约吧</title>
    <meta charset="UTF-8">
	...
	<script src="/Template/Mobile/js/khdd-ui.js"></script>
    ...
    <link rel="stylesheet" href="/Template/Mobile/css/amazeui.min.css" as="style" onload="this.rel='stylesheet'">
     <link rel="stylesheet" href="/Template/Mobile/css/khdd-style.css" as="style" onload="this.rel='stylesheet'">
...
<div style="height: 34px;display: inline-block;background-color: #FFFFFF;width: 100%">
    <div class="am-fl" style="color: #dedede;margin-top: 6px">
        <i class="iconfont icon-icon100" style="margin-left: 10px"></i>
        <marquee style="width: 90vw;font-size: 13px;
    height: 20px;
    line-height: 20px;
    vertical-align: top;
    display: inline-block;
    box-sizing: border-box;
    color: #06030B;">负距离的接触，帝王般的邂逅，全国顶级资源，专业级的服务！模特、网红、御姐、萝莉、空姐、学生、良家、少妇，总有一款属于你！</marquee>
    </div>
</div>

<div style="margin-top: 10px">
    <img src="/Template/Mobile/images/1.png" height="26px">
    <span style="color: #06030B;font-size: 20px"><b>热门游戏</b></span>
    <span onclick="javascript:location.href= '/Index.lotteryHall.do'" style="position: absolute;right: 20px;color: #aaaaaa;font-size: 13px;margin-top: 4px">更多</span>
</div>
...
<div class="credit">
    <ul class="am-cf">
        <li class="home_main_list">
            <div>
                <a href="/Game.k3.code.f1k3.do">
                    <img src="/Template/Mobile/images/a1k3.png">
                    <!--                            <i class="iconfont icon--shishicai" style="font-size: 50px;color: #fa7e00;"></i>-->
                    <div class="hot-periods">
                        <span style="font-size: 12px;letter-spacing:1px;color: #aaaaaa;">约炮任务</span>
                    </div>
                </a>
            </div>
        </li>
        <li class="home_main_list">
            <div>
                <a href="/Game.k3.code.jl2k3.do">
                    <img src="/Template/Mobile/images/a2k3.png">
                    <!--                            <i class="iconfont icon--shishicai" style="font-size: 50px;color: #fa7e00;"></i>-->
                    <div class="hot-periods">
                        <span style="font-size: 12px;letter-spacing:1px;color: #aaaaaa;">空降任务</span>
                    </div>
                </a>
            </div>
        </li>
        <li class="home_main_list">
            <div>
                <a href="/Game.k3.code.jl3k3.do">
                    <img src="/Template/Mobile/images/a3k3.png">
                    <!--                            <i class="iconfont icon--shishicai" style="font-size: 50px;color: #fa7e00;"></i>-->
                    <div class="hot-periods">
                        <span style="font-size: 12px;letter-spacing:1px;color: #aaaaaa;">同城任务</span>
                    </div>
                </a>
            </div>
        </li>
        <li class="home_main_list">
            <div>
                <a href="/Game.k3.code.jl4k3.do">
                    <img src="/Template/Mobile/images/a4k3.png">
                    <!--                            <i class="iconfont icon--shishicai" style="font-size: 50px;color: #fa7e00;"></i>-->
                    <div class="hot-periods">
                        <span style="font-size: 12px;letter-spacing:1px;color: #aaaaaa;">一夜情任务</span>
                    </div>
                </a>
            </div>
        </li>
...
<div style="margin-top: 10px">
    <img src="/Template/Mobile/images/1.png" height="26px">
     <span style="color: #06030B;font-size: 20px"><b>精品推荐</b></span>
</div>
<!--<div class="alert toast" onclick="mizhu.toast('已取消关注', 6000);"><?php echo ($m); ?></div>-->
<div style="padding: 10px;">
    <?php if(is_array($rm)): $i = 0; $__LIST__ = $rm;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($m == 0): ?><div class="videoItem alert" onclick="<?php echo ($khdd); ?>">
        <?php else: ?> 
            <div class="videoItem" onclick="javascript:location.href = '/Other.info.do?id=<?php echo ($vo["id"]); ?>'"><?php endif; ?>
            <img src="<?php echo ($vo["image_link"]); ?>" class="img2">
            <img src="/Template/Mobile/images/3.png" class="play">
            <h3><?php echo ($vo["name"]); ?></h3>
            <span>评分：<?php echo ($vo["fraction"]); ?></span>
            <img src="/Template/Mobile/images/2.png" class="cite">
        </div><?php endforeach; endif; else: echo "" ;endif; ?>

<div style="margin-top: 20px">
    <img src="/Template/Mobile/images/1.png" height="26px">
     <span style="color: #06030B;font-size: 20px"><b>国产无码</b></span>
</div>

<div style="margin-top: 5px;display: flex;flex-wrap: wrap">
    <?php if(is_array($gc)): $i = 0; $__LIST__ = $gc;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="videoItem1" onclick="javascript:location.href = '/Other.info.do?id=<?php echo ($vo["id"]); ?>'">
            <img src="/Template/Mobile/images/4.png" class="cite1">
            <img src="<?php echo ($vo["image_link"]); ?>" class="img3">
            <h3><font color="#778899"><?php echo ($vo["name"]); ?></font></h3>
            <span>评分：<?php echo ($vo["fraction"]); ?></span>
        </div><?php endforeach; endif; else: echo "" ;endif; ?>
</div>
...
<div style="margin-top: 30px">
    <img src="/Template/Mobile/images/1.png" height="26px">
    <span style="color: #06030B;font-size: 20px"><b>日本女优</b></span>
</div>

<div style="margin-top: 5px;display: flex;flex-wrap: wrap">
    <?php if(is_array($rh)): $i = 0; $__LIST__ = $rh;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="videoItem1" onclick="javascript:location.href = '/Other.info.do?id=<?php echo ($vo["id"]); ?>'">
            <img src="/Template/Mobile/images/4.png" class="cite1">
            <img src="<?php echo ($vo["image_link"]); ?>" class="img3">
            <h3><font color="#778899"><?php echo ($vo["name"]); ?></font></h3>
            <span>评分：<?php echo ($vo["fraction"]); ?></span>
...
<div style="margin-top: 30px">
    <img src="/Template/Mobile/images/1.png" height="26px">
   <span style="color: #06030B;font-size: 20px"><b>欧美精品</b></span>
</div>

<div style="margin-top: 5px;display: flex;flex-wrap: wrap">
    <?php if(is_array($om)): $i = 0; $__LIST__ = $om;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="videoItem1" onclick="javascript:location.href = '/Other.info.do?id=<?php echo ($vo["id"]); ?>'">
            <img src="/Template/Mobile/images/4.png" class="cite1">
            <img src="<?php echo ($vo["image_link"]); ?>" class="img3">
            <h3><font color="#778899"><?php echo ($vo["name"]); ?></font></h3>
            <span>评分：<?php echo ($vo["fraction"]); ?></span>
...
<script src="/Template/Mobile/js/jquery-3.1.1.min.js" defer="defer"></script>
<script src="Template/Mobile/js/amazeui.min.js" defer="defer"></script>
<style>
...
<script>
    $('#khdd').click( function() {
        ...
        $.ajax({
              cache: false,
              type: "GET" 
              url : "ajax_response.php?id=1&num=8" 
