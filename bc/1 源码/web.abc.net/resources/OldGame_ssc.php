			...
			<ul class="system_lottery" style="width: 1506px;">
				...
				<volist name="ssclist" id="vo">
					<li <if condition="$vo['name'] eq $lotteryname">class="curr"</if> lotteryname="{$vo.name}">
						<a href="__ROOT__/OldGame.ssc?code={$vo.name}">{$vo.title}</a>
					</li>
				</volist>	
			</ul>
			<span class="next">
					...
					<div class="bar-bet">
						<div class="fromList">
							<div class="checkbox pull-left bet-add ">
								...
								<button type="button" class="btn btn-danger fl bet-add commitbtn btn-tj">提交注单</button>
						</div>
