...
<header class="header" style="background:#000;height:40px;line-height:40px;">
    ...
    <li class="user_login_info4">
        <a href="{:U('Account/bankRecharge')}" style="color:#fff;">充值</a>
    </li>
...
<script>
    $(function () {
		...
		<php>if(!substr(I('code'),'lhc')){</php>
			var cp_name="{:I('code')}";
		//getUserBetsListToday(cp_name);
		//setInterval('getUserBetsListToday("'+cp_name+'")',5000);
		<php>}</php>
