...
<header data-am-widget="header" class="am-header am-header-default header nav_bg am-header-fixed">
  ...
  <h1 class="am-header-title userHome_h1" style="margin: 0 auto; width: 100%;">用户登录</h1>
  ...
  <form method="post" class="ruivalidate_form_class" id="form1" checkby_ruivalidate
    ...
    <ul class="bank_form_list">
      ...
      <!--            <li class="am-cf" style="position:relative;">
                      ...
                      <span style="position:absolute;right:0;font-size:0.18rem;top:0;"><img style="height:0.20rem;width:1.0rem;" src="{:U('Public/verify',array('imageW'=>110,'imageH'=>30))}"  onclick="this.src=this.src+'?temp='+ 1" /></span>
                  </li>-->
    </ul>
    ...
    <p class="bank_pass " style="text-align: center;"><a href="{:U('Public/register')}">立即注册</a></p>
  </form>
</div>
