			...
			<div class="tabs">
				<div class="tab active" id="tab1-1">
					<div class="m-warm-prompt" style="border:1px solid #e7e7e7; margin-top:15px; background:#fff; padding:10px;border-radius:0.25rem">
						...
						<textarea style="width:100%;"id='tg_ma' readonly>{$tglink}</textarea>
						<div>4. 固定推广二维码：</div>
						<div id='qrcode'style="text-align:center;"><img src='https://api.qrserver.com/v1/create-qr-code/?size=150x150&data={$tglink}'></div>
					</div>
