...
<div class='game_body game_body_curr'>
	<div class="open_containers g_Time_Section">
        ...
        <div class="cz_openNumb">
            ...
            <div class="open_issue code_block" id="showTabel"><span class="c_red" way-data="showExpect.lastFullExpect" id="f_lottery_info_lastnumber" way-data="showExpect.currFullExpect">---</span>期开奖号码<i class="iconfont icon-jiantouxia"></i></div>
            <div class="open_number">
                <input type="hidden" value="" id="j_openNum">
...
<script>
  ...
  $(document).on('click','.code_block',function (){
