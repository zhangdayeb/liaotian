			...
			for(var o in lotlist){
				...
				var haoma_html='';
						for (var iii=0; iii<array.length; iii++) { 
							var temp=iii;
							if(iii<0)iii='0'+iii;
							haoma_html =haoma_html+"<span class ='lhcode' style='background:"+lhc_numData['lhc_'+array[iii]]['bo']+";'>"+array[iii]+"</span>&nbsp;";
							iii=temp;
						}
						haoma_html =haoma_html+"<br/>";
						for (var iii=0; iii<array.length; iii++) { 
							haoma_html =haoma_html+lhc_numData['lhc_'+array[iii]]['sx']+"&nbsp;";
						}
				html += '<tr><td width="130" style="border-right: 1px solid #a7a182;">'+openinfo.expect+'</td><td width="46" class="c_red fb" style="padding:5px;">'+haoma_html+'</td><td width="40" class="c_blue fb" style="padding:5px;">'+yopentime+'</td></tr>';
...
//			}
	...
	function shengxiao_codes(){
		var ll = ['猪','鼠','牛','虎','兔','龙','蛇','马','羊','猴','鸡','狗'],
