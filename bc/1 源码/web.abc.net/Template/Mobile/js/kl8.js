...
var lotteryopencodes = function(lotteryname){
	...
	$.post(url, {'lotteryname':lotteryname}, function(data) {
        ...
        var yopentime = yopentimes_arr[1];
				html += '<tr><td width="130" style="border-right: 1px solid #a7a182;">'+openinfo.expect+'<br>'+yopentime+'</td><td width="46" class="c_red fb" style="padding:5px;color:red;"><div style="width:230px;">'+openinfo.opencode+'</div></td></tr>';
            ...
            if (msg.sign == true) {
                if (msg.data.opencode.length > 0) {
                    ...
                    if (lastExpect == openexpect) {
                        ...
                        var yopentimes_arr = yopentimes.split(' ');
                        var yopentime = yopentimes_arr[1];
                        var html = '<tr><td class="lsqh" style="border-right: 1px solid #a7a182;">' + openexpect + '<br>'+yopentime+'</td><td style="padding:5px;" class="c_red fb';
