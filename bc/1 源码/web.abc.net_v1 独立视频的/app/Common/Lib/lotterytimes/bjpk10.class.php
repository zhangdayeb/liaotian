...
class bjpk10 {
	function drawtimes(){
        ...
        //$draws[179]['end'] = date('Y-m-d H:i:s',strtotime($openstart)+86400);
		...
		if(!$nowqihao){
			...
			$actionNo = 179 * ($_day+1) + intval($nowqihao) + 622349+80422-308;
			...
			$actionNo = $total * $_day + intval($nowqihao) + 622349+80422-308;
			$nowdraws = [
				'expect'  => $actionNo,
