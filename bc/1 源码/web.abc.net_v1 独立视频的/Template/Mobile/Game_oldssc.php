		...
		<ul class="yGame_list">
			<volist name="ssclist" id="vo">
				<li class="<if condition="$vo['name'] eq $lotteryname">curr</if> am-modal-actions-header" lotteryname="{$vo.name}">
					<a href="__ROOT__/Game.oldssc?code={$vo.name}" style="padding: 0;">{$vo.title}</a>
				</li>
			</volist>
		</ul>
  </header>
			...
			<if condition="$nowcpinfo['iswh'] eq 0">
				...
				<div class="numberLan" style="display: none;">
					<header data-am-widget="header" class="am-header am-header-default header nav_bg am-header-fixed am-no-layout">
						...
						<div class="xiad-left" style="margin-top:0px; ">
...
<div class="am-modal-actions  am-modal-active" id="my-actions" style="display:none;">
  ...
  <script type="text/template" data-nav='整合'>
    <div class="ch_numball six_numball ball-red">
        <div class="lot-number-tip betTitle red">
			<i class="minus"></i>
        	<var>第一球</var>
            <div class="gray" style="display: inline;">赔率</div>
        </div>
        <ul class="hmp hmxzq xmcode" data-title="第一球">

        </ul>
        <div style="clear: both; padding:20px 0 0; margin-bottom: 10px; border-bottom: 1px solid #ddd;"></div>
        <div class="lot-number-tip betTitle red">
        	<i class="minus"></i>
        	<var>第二球</var>
            <div class="gray" style="display: inline;">赔率</div>
        </div>
        <ul class="hmp hmxzq xmcode" data-title="第二球">
        ...
        <ul class="hmp hmxzq xmcode" data-title="第三球">
        ...
        <ul class="hmp hmxzq xmcode" data-title="第四球">
        ...
        <ul class="hmp hmxzq xmcode" data-title="第五球">
        ...
        <ul class="hmp hmxzq xmcode" data-title="总和">

        </ul>
        <div style="clear: both; padding:20px 0 0; margin-bottom: 10px; border-bottom: 1px solid #ddd;"></div>
        <div class="lot-number-tip betTitle red"><var>特殊玩法</var>
            <div class="gray" style="display: inline;">赔率</div>
            <select class="wanfas">
                <option value="前三">前三</option>
                <option value="中三">中三</option>
                <option value="后三">后三</option>
            </select>
        </div>
        <div class="qhouz">
            <ul class="hmp hmxzq xmcode" data-title="前三">
                
            </ul>
            <ul class="hmp hmxzq xmcode" data-title="中三" style="display: none">
                
            </ul>
            <ul class="hmp hmxzq xmcode" data-title="后三" style="display: none">
...
<script type="text/javascript">
    var gameaj=new games('0','整合');
        ...
        $('.changeBtn').find('ul').on('click',function(){
        	window.location.href='/Game.ssc?code='+lotteryname;
        });
</script>			
</body>
</html>