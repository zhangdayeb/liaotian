...
<!--		<div class="winners_tab am-header-title">
	...
	<div data-am-widget="tabs" class=" am-tabs-d2 billrecord_main">
		<ul class="am-tabs-nav am-cf">
			...
			<li <if condition="$Think.get.a_item eq '2'">class="am-active"</if>><a href="{:U('Member/betRecord',array('a_item'=>2))}">已做单</a></li>
			<li <if condition="$Think.get.a_item eq '3'">class="am-active"</if>><a href="{:U('Member/betRecord',array('a_item'=>3))}">未做单</a></li>
			<li <if condition="$Think.get.a_item eq '4'">class="am-active"</if>><a href="{:U('Member/betRecord',array('a_item'=>4))}">等待数据单</a></li>
		</ul>
						...
						<ul class="am-list">
							<!-- <volist name="tzlist" id="vo">
									<li class="am-g am-list-item-dated">
										...
										<p class="am-cf billrecord_time">
											...
											<if condition="$vo.isdraw eq '0'"><em class="am-fr">{$vo.cptitle}(未做单)</em></if>
											<if condition="$vo.isdraw eq '1'">
												<em class="am-fr">{$vo.cptitle}</em><em class="money am-fr" style="margin-right:1em">做单金额:{$vo.okamount}</em></if>
											<if condition="$vo.isdraw eq '-1'"><em class="am-fr" style="color:green">{$vo.cptitle}(未做单)</em></if>
										</p>
									</li>
							</volist>-->
							<volist name="tzlist" id="vo">
							<li class="am-g am-list-item-dated">
								<p class="am-cf" style="font-size:14px">
									...
									<em class="money am-fr" style="color:#666" >未做单</em>
									</if>
									<if condition="$vo.isdraw eq '1'">
									<em class="money am-fr" style="color:red" >已做单</em>
									</if>
									<if condition="$vo.isdraw eq '-1'">
									<em class="money am-fr" style="color:green" >未做单</em>
									</if>
								...
								<p class="am-cf billrecord_time" style="font-size:14px">
									<span class="what_type am-fl">任务：{$vo.playtitle}({$vo.mode})</span>
								</p>
									<p class="am-cf billrecord_time" style="font-size:14px">
									<span class="what_type am-fl">下单内容({$vo.tzcode})</span>
								</p>
								<p class="am-cf billrecord_time" style="font-size:14px">
									<span class="what_type am-fl">单号：{$vo.trano}</span>
								</p>
								<p class="am-cf billrecord_time" style="font-size:14px">
									<span class="what_type am-fl">金额:{$vo.amount},注数:{$vo.itemcount},做单金:{$vo.okamount},做单数:{$vo.okcount}</span>
									<if condition="$vo.isdraw eq '0'">
