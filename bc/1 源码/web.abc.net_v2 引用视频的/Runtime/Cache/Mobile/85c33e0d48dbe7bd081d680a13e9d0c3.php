...
<div style="display: flex;flex-wrap: wrap;margin-bottom: 80px;margin-top:96px">
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="videoItem1" onclick="javascript:location.href = '/Other.info.do?id=<?php echo ($vo["id"]); ?>'">
            <img src="/Template/Mobile/images/4.png" class="cite1">
            <img src="<?php echo ($vo["image_link"]); ?>" class="img3">
            <h3><font color="#FF0000"><?php echo ($vo["name"]); ?></font></h3>
