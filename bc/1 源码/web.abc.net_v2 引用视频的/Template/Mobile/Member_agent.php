...
<div class="page-group">
  ...
  <div class="buttons-tab">
    ...
    <a href="#tab3" class="tab-link button" data-tabid="lotteryreport" onclick="1allUserList();">下线</a>
    <!--<a href="{:U('Member/agents')}" class="tab-link button" data-tabid="lotteryreport">下线</a>-->
  ...
  <div class="content-block" style="">
    <div class="tabs">
			...
			<div class="tabs">
				<div class="tab active" id="tab1-1">
					<div class="m-warm-prompt" style="border:1px solid #e7e7e7; margin-top:15px; background:#fff; padding:10px;border-radius:0.25rem">
						...
						<div>3. 固定推广链接：</div>
						<textarea style="width:100%;" readonly>{$host}{$_SERVER['HTTP_HOST']}/Public.register.tgid.{$userinfo.id}</textarea>
					</div>
				...
				<ul>
				  ...
				  <li class="nuonlinepayname">
					...
					<li class="nuonlinepayname">
						<div class="item-content">
							<div class="item-inner">
								<div class="item-title label">任务返点：</div>
								<div class="item-input">
      ...
      <div id="tab3" class="tab allUserListsearchbar">
          <div class="buttons-tab khdd">
            <a href="#" class="tab-link button" onclick="showDiv();">一级用户</a>
            <a href="#" class="tab-link button" onclick="hideDiv();">二级用户</a>
            </div>
		<div id="div1" class="tab allUserListsearchbar active">
    ...
    <div id="div2" class="tab allUserListsearchbar">
		<!--<div class="searchbar row">-->
		<!--	<div class="search-input col-50">-->
		<!--		<input class="layriqi starTime date-input-picker" id="userSearchStartTime" placeholder="开始时间" type="text" readonly="">-->
		<!--	</div>-->
      ...
      <div id="tab5" class="tab">
		<div class="searchbar row">
			...
			<div class="search-input col-33">
					...
					<select class="lotteryname" id="downUserBetsSearchShortName"><option value="">全部任务</option>
		...
		<div class="searchbar row">
			<div class="search-input col-33">
				<select class="state" id="downUserBetsSearchState">
					...
					<option value="0">等待数据单</option>
					<option value="-1">未做单</option>
					<option value="1">已做单</option>
