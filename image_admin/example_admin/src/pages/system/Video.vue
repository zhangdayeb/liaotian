<template>
  <div class='page-content'>
    ...
    <el-table :data="lists" :showPage="false" border ref="table">
      ...
      <el-table-column label="封图片" width="100" prop="image" v-if="columns[3].show">
      ...
      <el-table-column label="排序值" width="80" prop="order_num" v-if="columns[5].show"/>
      <el-table-column label="视频类型" width="100" prop="type" v-if="columns[6].show">
        <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    uploadFile: function (file) {
      ...
      axios.post('/uploadCommon/uploadImage', fm).then(res => {
        var arr = {
