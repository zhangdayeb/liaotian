<template>
  <div class='page-content'>
          ...
          <el-row :gutter="20">
            ...
            <el-col :xs="24" :sm="12" :lg="6">
              <el-form-item label="城市：">
                <el-select v-model="city_id" style="width:100%" filterable placeholder="城市">
    ...
    <el-table :data="lists" :showPage="false" border ref="table">
      ...
      <el-table-column label="城市" width="130" prop="city_name" v-if="columns[1].show"/>
      <el-table-column label="名称" width="130" prop="name" v-if="columns[2].show"/>
      <el-table-column label="图片" width="150" prop="image" v-if="columns[3].show">
      ...
      <el-table-column label="备注" width="150" prop="remark" v-if="columns[5].show"/>
    ...
    <el-dialog title="编辑" width="500px" :visible.sync="dvEdit">
      <el-form ref="model" :model="model" label-width="80px">
        <el-form-item label="城市">
          <el-select v-model="model.city_id" style="width:100%" filterable placeholder="请选择城市">
            <el-option v-for="item in cityList" :key="item.id" :label="item.name" :value="item.id"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="名称">
        ...
        <el-form-item label="图片">
          <span style="color:red">注意：只能上传jpg/png文件，建议尺寸300*300</span>
          <el-upload
            ...
            <img v-if="image" :src="image" style="width:140px;height: 140px;">
...
<script>
import {getBeautifulList, editBeautiful, deleteBeautiful} from '@/api/beautifulApi';
import {getCityListAll} from '@/api/cityApi';
