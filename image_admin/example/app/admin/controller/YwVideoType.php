...
use app\common\model\mysql\YwVideoType as models;
use app\common\model\mysql\CommonAdmin as commonModels;
use app\common\model\mysql\CommonLog;
use app\common\validate\YwVideoType as ValidateModel;
use think\exception\ValidateException;

class YwVideoType extends BaseController
{
    ...
    public function edit(){
        ...
        if(!empty($receiveData['id'])){
            ...
            //写入日志
            CommonLog::insertLog($admin['id'],'/yw-video-type/edit','',$data,2);
        }else{
            $data['create_time'] = date('Y-m-d H:i:s');
            models::insert($data);
            //写入日志
            CommonLog::insertLog($admin['id'],'/yw-video-type/edit','',$data,1);
        }
        jsonSuccess();
    }
    ...
    public function delete(){
        ...
        //写入日志
        CommonLog::insertLog($admin['id'],'/yw-video-type/delete',$load,'',3);
        jsonSuccess();
    }
